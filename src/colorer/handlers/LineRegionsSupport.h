...
class LineRegionsSupport : public RegionHandler
{
 public:
  ...
  void addRegion(size_t line_no, String* line, int start_idx, int end_idx, const Region* region) override;
  void enterScheme(size_t line_no, String* line, int start_idx, int end_idx, const Region* region, const Scheme* scheme) override;
  void leaveScheme(size_t line_no, String* line, int start_idx, int end_idx, const Region* region, const Scheme* scheme) override;
