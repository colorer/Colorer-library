...
void LineRegionsSupport::addRegion(size_t line_no, String* /*line*/, int start_idx, int end_idx, const Region* region)
{
...
void LineRegionsSupport::enterScheme(size_t line_no, String* /*line*/, int start_idx, int /*end_idx*/, const Region* region, const Scheme* scheme)
{
...
void LineRegionsSupport::leaveScheme(size_t line_no, String* /*line*/, int /*start_idx*/, int end_idx, const Region* /*region*/, const Scheme* /*scheme*/)
{
