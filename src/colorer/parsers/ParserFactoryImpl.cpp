...
UnicodeString ParserFactory::Impl::searchCatalog() const
{
...
#ifdef WIN32
void ParserFactory::Impl::getPossibleCatalogPaths(std::vector<UnicodeString> &paths) const
{
...
const char* ParserFactory::Impl::getVersion()
{
